...
--- fee is less than 1/50th of the monthly maintenance cost? Return the facid, facility name,
...
--- for the date '2012-09-21'? Return as list of start time and facility name pairings, 
--- ordered by the time.
